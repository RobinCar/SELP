...
/*
    static Body parse(Token token, List<VarDef> defs) throws IOException, UnexpectedCharacter {
    ...
    static Body parseSimpleBody(Token token, List<VarDef> defs) throws IOException {
